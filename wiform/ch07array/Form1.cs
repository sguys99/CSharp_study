...
namespace ch07array
{
    public partial class Form1 : Form
    {
        ...
        private void ArrayClassTest()
        {
            ...
            //Array는 클래스이다.
            Array.Clear(iTest, 2, 2); //2번부터 2개 삭제
            Array.Resize(ref iTest, 10); //사이즈 조정

            int iSearch50 = Array.IndexOf(iTest, 50); //50이 들어있는 인덱스 찾기
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            lblArrayCount.Text = String.Format("전체 자료수 : {0}", iTest.Length.ToString());
        ...
        {
            dgDay.Rows.Clear();
            int[,] iTest = { { 10, 5, 30, 4, 15, 22, 18 }, { 10, 5, 30, 4, 15, 22, 18 } };
